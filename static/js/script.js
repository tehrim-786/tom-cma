const dropList = document.querySelectorAll(".for select"),
  fromCurrency = document.querySelector(".for select"),
  toCurrency = document.querySelector(".to select"),
  getButton = document.querySelector(".ratss");
...
const exchangeIcon = document.querySelector(".for .icon1");
...
function getExchangeRate() {
  const amount = document.querySelector(".for input");
  const exchangeRateTxt = document.querySelector(".for .exchange-rate");
  ...
  let url = `https://v6.exchangerate-api.com/v6/a5cc2f3e5ce7a5e50fe94c42/latest/${fromCurrency.value}`;
